...
class UserForm(FlaskForm):
    ...
    tipo_user = SelectField(label="Tipo de usuário", choices=[
        ("default_user", "Usuário Padrão"), ("admin", "Administrador")])
    
    licenses = SelectField(label="Selecione a Licença", choices=[])
    submit = SubmitField(label="Salvar Alterações")
    
    def __init__(self, tipoUsr: str = None, licenses: list[tuple] = None,
                 *args, **kwargs):
